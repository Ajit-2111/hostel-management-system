...
if ($_POST['update']) {
	...
	$aid = $_SESSION['id'];
	$udate = date('Y-m-d');
	$query = "update admin set email=?,updation_date=?,mobile_no=?,gender=? where id=?";
	$stmt = $mysqli->prepare($query);
	$rc = $stmt->bind_param('ssssi', $email, $udate,$mobile_no,$gender, $aid);
	$stmt->execute();
							...
							<div class="row">
								<div class="col-md-6">
									<div class="panel panel-default">
										<div class="panel-heading"><?php echo $row->type; ?> profile details</div>
										<div class="panel-body">
											<form method="post" class="form-horizontal">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" name="mobile_no" id="mobile_no" value="<?php echo $row->mobile_no; ?>" required="required">
...
<option value="others">Others</option>
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" name="type" id="type" value="<?php echo $row->type; ?>" required="required" readonly>
