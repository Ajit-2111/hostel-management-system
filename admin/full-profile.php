			  ...
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  <td width="32%" valign="top" class="heading">Room no : </td>
                    ...
                    <tr>
                    <td width="32%" valign="top" class="heading">Branch : </td>
                  
                  <td class="comb-value1"><span class="comb-value"><?php echo $row['branch'];?></span></td>
                </tr>
                    <tr>
                    <td width="32%" valign="top" class="heading">Semester : </td>
                  
                  <td class="comb-value1"><span class="comb-value"><?php echo $row['semester'];?></span></td>
                </tr>
                    <tr>
                    <td width="32%" valign="top" class="heading">Course : </td>
                  
                  <td class="comb-value1"><span class="comb-value"><?php echo $row['course'];?></span></td>
                </tr>
             
                  <td width="32%" valign="top" class="heading">Building : </td>
                  
                      <td class="comb-value1"><span class="comb-value"><?php echo $row['Building'];?></span></td>
                    </tr>
                  <tr>
