...
{
$query="insert into  rooms (seater,Building,room_no,fees) values(?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('isii',$seater,$bldname,$roomno,$fees);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" class="form-control" name="bldname" id="bldname" value="" required="required">
</div>
</div>
<div class="form-group">
